		...
		if (step === 0) {
			return (
				<Grid item>
					<ul>
						<li>
							On this page, you will be asked to copy a piece on
							text onto the digital canvas. As this is just a
							practice, your handwriting will not be recorded
							during this stage.
						</li>
					</ul>
				</Grid>
			...
			return (
				<>
					<Grid item>
						<ul>
							<li>
								Please ensure that your handwriting written in
								staight lines and that any words are not
								truncated.
							</li>
						</ul>
					</Grid>
			...
			return (
				<Grid item>
					<ul>
						<li>
							If you make a mistake, tap the reset button on the
							top right corner to clear the canvas.
						</li>
						<li>
							When done, tap the continue button continue to the
							next stage.
						</li>
					</ul>
				</Grid>
